...
app.post("/", usersTokenAuth, uploadAsync, books.create);
app.put("/:id", usersTokenAuth, uploadAsync, books.update_by_id);
app.delete("/:id", usersTokenAuth, books.delete_by_id);
